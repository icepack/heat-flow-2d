...
\begin{align}
    ...
    & \quad\qquad + \int_\Omega\left(h\omega(E\chi_{\omega\ge 0} + E_a\chi_{\omega \le 0}) - f_s\right)\psi\big|_{\zeta = 1}\,dx \nonumber \\
    & \qquad\qquad - \int_\Omega\left(h\omega(E\chi_{\omega\le 0} + E_b\chi_{\omega\ge 0}) - f_b\right)\psi\big|_{\zeta = 0}\,dx
